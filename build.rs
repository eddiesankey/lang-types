...
fn main() {
    ...
    let syntax_tree = parse_file(&generated_code).expect("Failed to parse generated code");
    ...
    if needs_generation {
        fs::write("src/languages.rs", formatted_code).expect("Failed to write src/languages.rs");
    }
